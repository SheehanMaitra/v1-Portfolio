    ...
    <div name="home" className="w-full h-screen bg-[#0a192f]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full pt-[100px] ">
        ...
        <div className="mb-[100px]">
          <button className="text-[#64ffda] ease-in-out text-bold border-[#64ffda] hover:-translate-y-[.4rem] duration-[350ms] border-[2px] px-4 py-2 my-1 flex items-center rounded-xl hover:bg-[#64ffda] hover:bg-opacity-20">
